package com.revenue.revenueCollection._model.request;

import java.math.BigDecimal;
import java.sql.Date;
import java.sql.Timestamp;

public class AgentDetailsRequestModel {
    ...
    public String toString() {
        return "AgentDetailsRequestModel{" +
                ...
                ", resetpin=" + resetpin +
                ", pinmaker='" + pinmaker + '\'' +
                ", pinmakerremarks='" + pinmakerremarks + '\'' +
                ", datepinreq='" + datepinreq + '\'' +
                ", usertype='" + usertype + '\'' +
                ", active=" + active +
                ", resetby='" + resetby + '\'' +
                ", resetdate=" + resetdate +
