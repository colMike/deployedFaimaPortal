...
//      // initialContext.lookup("java:/comp/env");java:jboss/datasources/ExampleDS
...
//
//        jasperDesign = JRXmlLoader.load(keyValue + "RptInvoice.jrxml");
...
//          response.setHeader(
//              "Content-disposition", "attachment; filename=" + "ENROLLED CUSTOMERS" + ".xlsx");
...
//      @RequestParam("businnessNo") String businnessNo,
//      @RequestParam(value = "approvedUser") String approvedUser,
//      @RequestParam(value = "appliedFor") String appliedFor,
...
//        jasperDesign = JRXmlLoader.load(keyValue + "RptInvoiceReceipt.jrxml");
//
//        jasperReport = JasperCompileManager.compileReport(jasperDesign);
//        jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, connection);
//
...
//        jasperDesign = JRXmlLoader.load(keyValue + "RptLandRateInvoice.jrxml");
//        jasperReport = JasperCompileManager.compileReport(jasperDesign);
//        jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, connection);
//
//        if (jasperPrint.getPages().size() != 0) {
...
//        jasperDesign = JRXmlLoader.load(keyValue + "RptLandReceipt.jrxml");
//
//        jasperReport = JasperCompileManager.compileReport(jasperDesign);
//        jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, connection);
//
...
//
//        jasperDesign = JRXmlLoader.load(keyValue + "RptPermit.jrxml");
//        jasperReport = JasperCompileManager.compileReport(jasperDesign);
//        jasperPrint = JasperFillManager.fillReport(jasperReport, parameters, connection);
//
//        if (jasperPrint.getPages().size() != 0) {
...
//  public void getLandReports(
//      @RequestParam(value = "type") String reportType,
//      @RequestParam("plotNumber") String plotNumber,
//      @RequestParam(value = "paidUser") String paidUser,
//      @RequestParam(value = "appliedFor") String appliedFor,
//      HttpServletRequest request,
//      HttpServletResponse response)
//      throws ServletException, IOException {
