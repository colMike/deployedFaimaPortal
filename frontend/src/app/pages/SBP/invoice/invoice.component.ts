 ...
 */
  ...
  printInvoice() {
    ...
    this.reportUrl = `http://localhost:20202/revenueCollection/api/erevenue/reports?type=I&businnessNo=${this.businessNo}&approvedUser=${this.approvedUser}&appliedFor=${this.appliedFor}`;
    // this.reportUrl = `http://197.220.114.46:20202/revenueCollection/api/erevenue/reports?type=I&businnessNo=${this.businessNo}&approvedUser=${this.approvedUser}&appliedFor=${this.appliedFor}`;
  }
