...
@NgModule({
  // tslint:disable-next-line: max-line-length
  declarations: [ProductsComponent, ProductDetailComponent, OrdersComponent, CartComponent, CheckoutComponent, ShopsComponent, AddProductComponent, OrderSortableDirective],
  imports: [
    CommonModule,
    FormsModule,
    DropzoneModule,
