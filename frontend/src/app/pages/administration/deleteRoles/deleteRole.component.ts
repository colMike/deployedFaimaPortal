...
export class deleteRoleComponent implements OnInit, OnDestroy {
...

  {
    ...
    this.group1.remarks = this.roleForm.get('remarks').value;
    if(this.group1.remarks =='' || this.group1.remarks==null ){
    ...
    this.group1.deletedBy=this.sessionId.entity.userId;
    const user2 = {
      'id': this.group1.id,
      'deleted':this.group1.deleted,
      'deletedBy':this.group1.deletedBy,
      'remarks':this.group1.remarks


    };
    console.log(user2,"$$$$$$$$$$$$$$$")
    console.log(this.group1, "$$$$$$$$$$$$$$$$")
    this.apiService.deleteRole(user2).subscribe((response) => {
      ...
      if (this.response.status===200) {
        ...
        return this.toastr.success('Great! The Role information was deleted successfully. Pending Approval', 'success!', { timeOut: 3000 });
