...
@Component({
  ...
  templateUrl: './approveCustomers.component.html'
})
 ...
 */
  ...
  Reject(){
    ...
    for (var i = 0; i <= this.users1.length - 1; i++) {
      console.log(this.users1[i].createdBy, "this.users1.deletedB")
      if(this.users1[i].createdBy === this.users1.approvedBy){

        return this.toastr.warning('User creator cannot reject a customer he/she created', ' Warning!', { timeOut: 3000 });
    ...
    this.customerSvc.approveCustomer(user2).subscribe((response) => {
      this.response = response;
      console.log(this.response.status,"response")
      if (this.response.status===200) {
...

  {
    ...
    for (var i = 0; i <= this.users1.length - 1; i++) {
      ...
      if(this.users1[i].createdBy === this.users1.approvedBy){
        ...
        return this.toastr.warning('User creator cannot approve a customer he/she created', ' Warning!', { timeOut: 3000 });
  ...
  getUsers(){
    ...
    this.customerSvc.getCustomersToApprove().subscribe(users =>{
      // if(data){
