...
@Component({
  ...
  templateUrl: './deleteCustomers.html'

})
export class deleteCustomers implements OnInit {
 ...
 */
...

  {
    ...
    this.users1.deleted_by=this.sessionId.entity.userId;
    const user2 = {
      'id': this.users1.id,
      'deleted':this.users1.deleted,
      'deleted_by':this.users1.deleted_by,
    ...
    this.customerSvc.deleteCustomer(user2).subscribe((response) => {
