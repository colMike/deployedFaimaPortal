...
//this.agents.agent_names = this.validationform.get('agent_names').value;
    ...
    if(this.agents.maker === this.agents.approvedBy){
    ...
    const agent1 ={
      ...
      'approvedBy':this.agents.approvedBy
  ...
  Approve(){
    ...
    this.agentSvc.approveAgent(agent1).subscribe((response) => {
      ...
      if (this.response.status===200) {
        ...
        this.isAddMode = true;
        //alert(response.respMessage);
        return this.toastr.success('Great! The Agent information was approved succesfully"', ' Success!', { timeOut: 3000 });
  ...
  saveAgent() {
    ...
    this.agentSvc.addAgent(this.agents).subscribe((response) => {
      ...
      if (this.response.status===200) {
        ...
        return this.toastr.error('Exception Occured', ' Success!', { timeOut: 3000 });
